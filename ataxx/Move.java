...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        int indexDiff = abs(_fromIndex - _toIndex);
        _isExtend = indexDiff == 1
                 || indexDiff == 10
                 || indexDiff == 11
                 || indexDiff == 12;
        _isJump = !_isExtend;
    ...
    public String toString() {
        ...
        String fromStr = String.valueOf(new char[] {_col0, _row0});
        String toStr = String.valueOf(new char[] {_col1, _row1});
